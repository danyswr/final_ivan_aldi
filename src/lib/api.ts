...
const API_URL =
  "https://script.google.com/macros/s/AKfycbwSxdhUGzge3dXCwtM0rFAt0kHw5NsiXUZ8tNE0hfRgCif4kgeKP5b_zgTG3lsxTJ7TPA/exec"

export async function makeAPICall<T = any>(data: any, endpoint?: string): Promise<ApiResponse<T>> {
  try {
    let payload: any = {}
