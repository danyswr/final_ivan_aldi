    ...
    <div className="space-y-6">
      ...
      {buyerOrders.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">Anda belum melakukan pemesanan apapun</p>
          <Link href="/buyer">
              ...
              <Card key={order[0]} className="hover:shadow-md transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-lg">Order #{order[0].slice(0, 8)}...</CardTitle>
                        ...
                        <div className="flex items-center gap-4">
                          {product[3] && (
                            <img
                              src={
                                product[3]
                                  .replace("/uc?export=view&id=", "/thumbnail?id=")
                                  .replace(/&.+/, "&sz=w80-h80") || "/placeholder.svg"
                              }
                              alt={product[2]}
                          ...
                          <div>
                            ...
                            <p className="text-lg font-semibold text-green-600">Total: {formatPrice(order[5])}</p>
                          </div>
                        </div>
                      ) : (
                        <div>
