...
import { ShoppingBag, RefreshCw, Search, TrendingUp, Package } from "lucide-react"
      ...
      <div className="space-y-8 pb-20">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-white/90 text-lg">Temukan produk terbaik untuk kebutuhan Anda</p>
                </div>
        ...
        <div className="modern-card p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex-1">
              <label className="block text-sm font-medium text-foreground mb-2">Cari Produk</label>
              <div className="relative">
                <Input
                  placeholder="Ketik nama produk atau deskripsi..."
                  value={searchQuery}
                  onChange={(e) => handleSearch(e.target.value)}
                  className="w-full pl-12 h-12 input-modern"
                />
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <div className="text-sm text-muted-foreground modern-card px-4 py-2">
          ...
          {filteredProducts.length === 0 ? (
            ...
            <div className="grid-responsive">
              {filteredProducts.map((product: any[]) => (
                <ProductCard key={product[0]} product={product} onOrder={handleOrder} />
              ))}
            </div>
          )}
        </div>
